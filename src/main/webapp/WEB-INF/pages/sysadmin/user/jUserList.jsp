                                        ...
                                        <tr>
                                            <td>
                                                <a href="list?currentPage=1">
                                                    <img src="../../staticfile/images/table/firstPageDisabled.gif"
                                                         style="border:0" alt="第一页"/>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="list?currentPage=${pageBean.currPage-1<=0? 1 : pageBean.currPage-1 }">
                                                    <img src="../../staticfile/images/table/prevPageDisabled.gif"
                                            ...
                                            <td>
                                                <img src="../../staticfile/images/table/separator.gif" style="border:0"
                                                     alt="Separator"/>
                                            </td>
                                            <td>
                                                <select name="pageSize" id="pageSize">
                                                    <option value="2"
                                                            <c:if test="${pageBean.pageSize==2 }">selected="selected"</c:if> >
                                                        2
                                                    </option>
                                                    <option value="3"
                                                            <c:if test="${pageBean.pageSize==3 }">selected="selected"</c:if> >
                                                        3
                                                    </option>
                                                    <option value="4"
                                                            <c:if test="${pageBean.pageSize==4 }">selected="selected"</c:if> >
                                                        4
                                                    </option>
                                                </select>
                                            </td>
