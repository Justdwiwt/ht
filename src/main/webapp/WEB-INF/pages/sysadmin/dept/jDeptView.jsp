    ...
    <div>
        ...
        <div class="eXtremeTable">
            <table id="ec_table" class="tableRegion" width="98%">
                <tr class="odd">
                    <td>部门编号：</td>
                    <td><input type="text" id="deptId" name="deptId" value="${dept.deptId }" readonly="readonly"/>
                ...
                <tr class="odd">
                    <td>部门状态：</td>
                    <td>
                        <input type="radio" name="state" value="1" readonly="readonly"
                               <c:if test="${dept.state==1}">checked="checked"</c:if> />启动
                        <input type="radio" name="state" value="0" readonly="readonly"
                               <c:if test="${dept.state==0}">checked="checked"</c:if>  />停用
                    </td>
                </tr>
            </table>
        </div>
