                        ...
                        <div style="float:right;width:80px;text-align:right;padding-right:7px;">
                            ...
                            <a style='cursor:pointer;' title="编辑"
                               onclick="msgupdate('ff8080813d00613e013d0067909e0009','edit')"><img
                                    src="${ctx}/staticfile/images/olmsg/doc_edit.gif"/></a>


                            <a style='cursor:pointer;' title="删除"
                               onclick="msgdel('ff8080813d00613e013d0067909e0009')"><img
                                    src="${ctx}/staticfile/images/olmsg/doc_del.gif"/></a>
            ...
            <table border=0 cellspacing="0" cellpadding="0" width="220">
                <tr>
                    <td style='cursor:move;' onmousedown="MDown(this,'ff8080813d00613e013d00681494000a')"
                        background="${ctx}/staticfile/images/olmsg/FFE7E81.gif" height="45">
                ...
                <tr>
                    <td style='cursor:move;white-space:nowrap;' width='100%'
                        ...
                        background="${ctx}/staticfile/images/olmsg/FFE7E82.gif">
                        <div style="float:left;width:130px;padding-left:7px;font-family:Tahoma;color:gray;font-style : oblique;">
                            2013-02-22 13:37
                        </div>
                        <div style="float:right;width:80px;text-align:right;padding-right:7px;">
