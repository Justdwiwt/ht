    ...
    <div class="panel">
        ...
        <div class="panel-header">
            ...
            <div class="panel-content">
                <ul>
                    <li><a href="${ctx}/staticfile/tomain.action?modelName=home" target="main" id="aa_3"
                           onclick="linkHighlighted(this)">我的留言板</a></li>
                    <li><a href="${ctx}/staticfile/home/workflow/tasklist.action" target="main" id="aa_2"
                           onclick="linkHighlighted(this)">我的代办任务</a></li>
                    <li><a href="${ctx}/staticfile/baseinfo/leavebill/list.action" target="main" id="aa_1"
                           onclick="linkHighlighted(this)">请假单管理</a></li>
                </ul>
            </div>
...
<div id="sidebar" class="sidebar">
    ...
    <div class="panel">
        ...
        <div class="panel-header">
            ...
            <div id="customerMenu">
                <div class="FastMenu"><img src="${ctx}/staticfile/skin/default/images/notice.gif"
...
<div id="sidebar" class="sidebar">
    ...
    <div class="panel">
        ...
        <div class="panel-header">
            ...
            <div class="panel-content">
                <ul>
                    <li><a href="${ctx}/sysadmin/userAction_toUpdatePassword" id="aa_2" onclick="linkHighlighted(this)"
                           target="main">个人信息修改</a></li>
